-- =============================================================================
-- Raw-events D7 retention (no views required)
-- =============================================================================
...
activity AS (
  SELECT DISTINCT resolved_user_id, event_date AS activity_date
  FROM user_events
),
...
FROM cohort_flags
WHERE DATE_ADD(cohort_date, INTERVAL 7 DAY) <= CURRENT_DATE()
